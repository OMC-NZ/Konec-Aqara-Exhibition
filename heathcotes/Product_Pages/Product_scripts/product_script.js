...
function redirectToIndex() {
    window.location.href = 'https://www.aqarahome.nz/heathcotes/index.html'; //<<< note full absolute path to ensure integrity, aka aqarahome.nz/xxx/index.html
}

// Buy Now URL - EDIT for customer
function redirectToStore() {
    window.open('https://www.heathcotes.co.nz/', '_blank'); //<<< note full absolute path to ensure integrity.
}
